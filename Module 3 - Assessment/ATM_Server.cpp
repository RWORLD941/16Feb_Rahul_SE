  ...
  depo_not_enough()
  {
    while (true)
    {
      ...
      if (depo >= 5000)
      {
        ...
        cout<<"\nEnter the Initial Depoist Amount: ";
        cin>>depo;
      };
    };
  }
...
class main_scr
{
  ...
  main_scr()
  {
    ...
    cout<<"\nPLEASE ENTER A SELECTION AND PRESS ENTER RETURN KEY:"<<endl;
    cin>>ch2;
    cout<<"\n\n******************************************************\n"<<endl;
  }
};
...
class deposit
{
  ...
  void deposited()
  {
    ...
    cout<<"\nEnter the Amount to be Deposited: Rs. "<<depo<<endl;
    total=bal+depo;
...
class withdraw
{
  ...
  void withdrawal()
  {
    ...
    cout<<"\n\n******************************************************\n"<<endl;
    cout<<"\nPresent available balance: Rs. "<<bal<<endl;
    cout<<"\nEnter the Amount to be Withdrawn: Rs. "<<with<<endl;
    total=bal-with;
    cout<<"\nYour new available Balanced Amount is Rs. "<<total<<endl;
    bal=total;
    cout<<"\n\nThank You!"<<endl;
